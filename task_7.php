...
$contacts = [
    [
        ...
        "avatarUrl" => "img/demo/avatars/avatar-b.png",
        "name" => "Oliver Kopyov",
    ...
    [
        "id" => "4",
        "filterTag" => "jim ketty",
        "avatarUrl" => "img/demo/avatars/avatar-k.png",
        "name" => "Jim Ketty",
    ...
    [
        "id" => "5",
        "filterTag" => "aaron tellus",
        "avatarUrl" => "img/demo/avatars/avatar-g.png",
        "name" => "Dr. John Oliver",
    ...
    [
        ...
        "avatarUrl" => "img/demo/avatars/avatar-h.png",
        "name" => "Sarah McBrook",
    ...
    [
        ...
        "avatarUrl" => "img/demo/avatars/avatar-i.png",
        "name" => "Jimmy Fellan",
    ...
    [
        ...
        "avatarUrl" => "img/demo/avatars/avatar-j.png",
        "name" => "Arica Grace",
        "position" => "Accounting, Gotbootstrap Inc.",
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="row js-list-filter" id="js-contacts">
        ...
        ?>
        <div class="col-xl-4">
            <div id="c_<?= $contact['id'] ?>" class="card border shadow-0 mb-g shadow-sm-hover"
                 data-filter-tags="<?= $contact['filterTag'] ?>">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                            <span class="status status-success mr-3">
                                <span class="rounded-circle profile-image d-block "
                                      style="background-image:url('<?= $contact['avatarUrl'] ?>'); background-size: cover;"></span>
                            </span>
                        ...
                        <button class="js-expand-btn btn btn-sm btn-default d-none waves-effect waves-themed"
                                ...
                                data-target="#c_<?= $contact['id'] ?> > .card-body + .card-body"
                                aria-expanded="false">
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <a href="mailto:<?= $contact['email'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                            <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?= $contact['email'] ?></a>
