            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="panel-content">
                        ...
                        ?>
                        <label class="form-label" for="simpleinput"><h4>Title:</h4> <?= $product['title'] ?></label>
                        <label class="form-label" for="simpleinput"><h5>Description:</h5> <?= $product['description'] ?></label>
                        <label class="form-label" for="simpleinput"><h5>Price:</h5> <?= $product['price'] ?></label><br>
                        <?php
                        }}
                        ?>
                    </div>
